...
function dnt4table(datetime) { var e = new Date(datetime); 
...
function payment_status_fomt(type, payment, amount, int_type, currency) { 
    ...
    if (type == int_type) { return '<div class="text-center"><span><div class="text-dark-75 font-weight-bolder d-block line-height-sm">'+ currency + ' ' + numberWithCommas(amount) +
